...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">SOCIALFLYLK</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <br>
                        <div class="container"><a href="/admin/index.html" class="btn btn-primary">Go Back</a></div>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <tbody>
                                        ...
                                        <td><?php echo $product['mobile_number']; ?></td>
                                        <td><?php echo $product['businnes_reg_number']; ?></td>
                                        <td><?php echo $product['phone_number']; ?></td>
                                        <td><?php echo $product['role']; ?></td>
                                        <td><?php echo $product['password']; ?></td>
                                        <td><a class="btn btn-danger" href="/admin/delete_users.php?id=<?php echo $product['id']; ?>">Delete</a></td>
                                        </tr> 
                                          <?php endforeach; ?>
                                    </tbody>
                                </table>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; SOCIALFLY.LK 2023</div>
                            <div>
